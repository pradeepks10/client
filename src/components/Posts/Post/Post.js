...
// this library help us to display a post 'x' sec ago post like that
            ...
            <ButtonBase className={classes.cardAction} onClick = {openPost} >
                ...
                {(user?.result?.googleId === post?.creator || user?.result?._id === post?.creator) && (
                    ...
                    <CardContent>
                        ...
                        <Typography variant="body2" color="textSecondary" component="p">{post.message.split(' ').splice(0, 20).join(' ')}{post.message.length > 20 ?'...':null}</Typography>
                    </CardContent>
            </ButtonBase>
